...
import { bluetoothService, hapticsService, storageService, ttsService } from '@/services/service-provider';
...
export default function MainScreen() {
  ...
  const connectWebSocket = () => {
    ...
    const wsUrl = process.env.EXPO_PUBLIC_WS_URL || 'ws://172.25.26.97:8080/ws';
